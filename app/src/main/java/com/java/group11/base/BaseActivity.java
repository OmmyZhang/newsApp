...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    @Nullable
    @BindView(com.java.group11.R.id.toolbar)
    Toolbar mToolbar;
    @Nullable
    @BindView(com.java.group11.R.id.drawer_layout)
    protected DrawerLayout mDrawerLayout;
    @Nullable
    @BindView(com.java.group11.R.id.nav_view)
    ...
    protected void setup(int barIconId) {
        ...
        if (this.mDrawerLayout != null) {
            this.mDrawerLayout.setStatusBarBackground(com.java.group11.R.color.colorPrimaryDark);
        }
