package com.java.group11.setting;
...
public class MySettingActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    @BindView(com.java.group11.R.id.linearLayout1)
    LinearLayout l1;
    @BindView(com.java.group11.R.id.linearLayout2)
    LinearLayout l2;
    @BindView(com.java.group11.R.id.linearLayout3)
    LinearLayout l3;

    @BindView(com.java.group11.R.id.sw_other_class)
    Switch otherClass;
    @BindView(com.java.group11.R.id.sw_auto_refresh)
    Switch autoRefresh;
    @BindView(com.java.group11.R.id.sw_no_picture)
    Switch noPicture;
    @BindView(com.java.group11.R.id.sw_backtage_voice)
    ...
    @BindView(com.java.group11.R.id.tag_layout)
    ...
    @BindView(com.java.group11.R.id.btn_sure)
    Button btnSure;
...
//    String[] mTextStr = { };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.java.group11.R.layout.activity_my_setting);
...
//        setup(R.drawable.ic_menu);
        ...
        inputLabel = (EditText) LayoutInflater.from(this).inflate(com.java.group11.R.layout.my_edit_text, null);
    ...
    private void initMarksView() {
        for (int i = 0; i < tagList.size(); i++) {
            View view = View.inflate(MySettingActivity.this, com.java.group11.R.layout.class_tag, null);
            TextView tv = (TextView) view.findViewById(com.java.group11.R.id.textView1);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    TextView tv = (TextView) v.findViewById(com.java.group11.R.id.textView1);
                    if ((Boolean) v.getTag()) {
                        v.setTag(false);
                        tv.setEnabled(false);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        switch (compoundButton.getId()) {
            case com.java.group11.R.id.sw_other_class:
                GlobalSetting.getINSTANCE().setAllowOtherClass(b);
                break;
            case com.java.group11.R.id.sw_auto_refresh:
                GlobalSetting.getINSTANCE().setAutoRefreshMayLike(b);
                break;
            case com.java.group11.R.id.sw_no_picture:
                GlobalSetting.getINSTANCE().setNoPicture(b);
                break;
            case com.java.group11.R.id.sw_backtage_voice:
...
/*
                ...
                if(label!=null&&!label.equals("")&&!GlobalSetting.getINSTANCE().checkNotShow(label)){
                    ...
                    for(int m = 0;m < mTagLayout.getChildCount()-1;m++){
                        newStr[m] =((TextView)mTagLayout.getChildAt(m).
                                findViewById(com.java.group11.R.id.text)).getText().toString();//根据  当前   位置查找到 当前    textView中标签  内容
                    }
                    list.add(label);
                    initLayout(list);
                    inputLabel.setText("");
    ...
    private void initLayout(final ArrayList<String> arr) {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            final View view = (View) LayoutInflater.from(MySettingActivity.this).inflate(com.java.group11.R.layout.text_view, mTagLayout, false);

            final TextView text = (TextView) view.findViewById(com.java.group11.R.id.text);  //查找  到当前     textView
            final TextView icon = (TextView) view.findViewById(com.java.group11.R.id.delete_icon);  //查找  到当前  删除小图标
